...
const MONTH_OPTIONS = [
  ...
  { value: "3", label: "3 (मार्च)" }, { value: "4", label: "4 (अप्रैल)" },
  { value: "5", label: "5 (मई)" }, { value: "6", label: "6 (जून)" },
  { value: "7", label: "7 (जुलाई)" }, { value: "8", label: "8 (अगस्त)" },
  { value: "9", label: "9 (सितम्बर)" }, { value: "10", label: "10 (अक्टूबर)" },
  { value: "11", label: "11 (नवम्बर)" }, { value: "12", label: "12 (दिसम्बर)" }
];
...
function MonthAttendance() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage({ text: `त्रुटि: ${error.message || 'सबमिशन में त्रुटि हुई। कृपया पुनः प्रयास करें।'}`, type: 'danger' });
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <>
          ...
          <Container fluid className="demand-center-report-page">
            <div className="demand-center-header">
              <div>
                ...
                <small className="text-muted">{centerName || "DHO कोटद्वार उद्यान विभाग"}</small>
              </div>
            ...
            {isLoading && !showFormModal ? (
              ...
              <Alert variant="info" className="demand-center-empty">
                <strong>कोई रिपोर्ट उपलब्ध नहीं है।</strong> कृपया "नई रिपोर्ट जोड़ें" पर क्लिक करें।
              </Alert>
            ) : (
                            ...
                            <tr key={report.id || index}>
                              ...
                              <td>
                                <div className="d-flex gap-2">
                                  <Button variant="warning" size="sm" onClick={() => openEditModal(report)}>
                                    <FaEdit />
                                  </Button>
      ...
      <Modal show={showFormModal} onHide={closeModal} size="lg" centered scrollable>
        ...
        <Form onSubmit={handleSubmit}>
          <Modal.Body style={{ maxHeight: '70vh', overflowY: 'auto' }}>
            ...
            <Row className="g-3">
              <Col md={12}>
                <Form.Group>
                  <Form.Label className="filter-label-sm">केंद्र का नाम (Center Name)</Form.Label>
                  <Form.Control
                    type="text"
                    name="center_name"
              ...
              <Col md={6}>
                <Form.Group>
                  <Form.Label className="filter-label-sm">माह (Month) <span className="text-danger">*</span></Form.Label>
                  <Form.Select
                    name="month"
              ...
              <Col md={6}>
                <Form.Group>
                  <Form.Label className="filter-label-sm">वित्तीय वर्ष <span className="text-danger">*</span></Form.Label>
                  <Form.Select
                    name="financial_year"
              ...
              <Col md={12}>
                <Form.Group controlId="formFile" className="mb-3">
                  <Form.Label className="filter-label-sm">
                    उपस्थिति फाइल अपलोड करें (Upload Excel/PDF) {!editingReport && <span className="text-danger">*</span>}
                  </Form.Label>
                  <Form.Control
                    type="file"
                  ...
                  {editingReport && (
                    <Form.Text className="text-muted d-block mt-1">
                      ...
                      वर्तमान फाइल: <a href={getFileUrl(editingReport.month_attendance)} target="_blank" rel="noopener noreferrer">यहां देखें</a>
                    </Form.Text>
                  )}
                </Form.Group>
              </Col>
          ...
          <Modal.Footer>
            ...
            <Button variant="primary" size="sm" type="submit" disabled={isLoading}>
              ...
              {isLoading ? 'सहेजा जा रहा है...' : (editingReport ? 'अपडेट करें' : 'रिपोर्ट सहेजें')}
            </Button>
          </Modal.Footer>
        </Form>
      </Modal>
